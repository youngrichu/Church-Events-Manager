...
class Calendar {
    ...
    public function load_events() {
        ...
        $start_date = $this->current_date->format('Y-m-01');
        $end_date = $this->current_date->format('Y-m-t');
        ...
        $events = $wpdb->get_results($wpdb->prepare(
            ...
            AND em.event_date BETWEEN %s AND %s
    ...
    public static function get_event_details($event_id) {
        ...
        $output .= '<a href="' . get_permalink($event_id) . '" class="view-event-link">' . 
